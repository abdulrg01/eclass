  ...
  return (
    <div className="w-[85%] m-auto py-5 mb-5">
      <div className="w-full relative">
        ...
        <button
          type="button"
          className="cursor-not-allowed focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-1 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
        >
        ...
        <div className="flex items-center">
          <input
            ...
            className={`${styles.input} xl:!w-[50%] md:!w-[60%] ml-3 !mt-0`}
          />
          <div
      ...
      <div className="w-full">
        ...
        {courseData?.benefits?.map((items, index) => (
